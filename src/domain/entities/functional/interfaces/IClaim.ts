...
export default interface IClaim {
    ...
    responsibleOrganizationName?: string;   // Наименование ответственной организации
    responsible_organization?: [{}];          // Возможные ответственные организации, привязанные к заявке
}
