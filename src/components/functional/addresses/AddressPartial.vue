...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCitiesList() {
                axios.get(fiasUrl + 'choose_cities?token=' + fiasToken,  {
            ...
            getStreetsList() {
                axios.get(fiasUrl + 'choose_streets/' + this.current.city.AOGUID + '?token=' + fiasToken,  {
                    transformRequest(data, headers) { delete headers.common.Authorization; return data; },
                }).then(response => {
            ...
            getBuildingsList() {
                axios.get(fiasUrl + 'choose_buildings/' + this.current.street.AOGUID + '?token=' + fiasToken,  {
                    transformRequest(data, headers) { delete headers.common.Authorization; return data; },
                }).then(response => {
