<template>
    <div class="tab-pane fade show active" id="current" role="tabpanel" aria-labelledby="closed_claims">
        <br>
...
<script lang="ts">
    ...
    export default class CloseClaims extends Vue {

        @Provide()
        public closedStatus: string = 'executed_totally';
