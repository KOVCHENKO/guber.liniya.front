...
<script lang="ts">
    ...
    import {EDITED} from '@/domain/services/functional/roles/interfaces/dispatchStatusTypes';
    ...
    export default class EditableClaims extends Vue implements IWithRoute {
        // Фильтры - Поиск, Статус приема, Статус обработки, Статус выполнения
        @Provide() public dispatchStatusFilter: string = EDITED;
